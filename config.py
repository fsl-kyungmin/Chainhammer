...
RPCaddress, RPCaddress2 = 'http://localhost:10000', 'http://localhost:20000' # use two different Quorum nodes for writing and reading  
RPCaddress, RPCaddress2 = 'http://localhost:10000', 'http://localhost:20000' # crux dockerized, see https://github.com/blk-io/crux/blob/master/README.md#4-node-quorum-network-with-crux
RPCaddress, RPCaddress2 = 'http://localhost:10000', 'http://localhost:20000'  # orbita-center_parity-poa-playground; parity-deploy
